...
def iplot(figure_or_data, show_link=True, link_text='Export to plot.ly',
    ...
    display_bundle = {
        'application/json+plotly.v1': {
            'data': json.loads(json.dumps(figure['data'], cls=plotly.utils.PlotlyJSONEncoder)),
            'layout': json.loads(json.dumps(figure['layout'], cls=plotly.utils.PlotlyJSONEncoder))
        },
        'text/html': plot_html
    }
